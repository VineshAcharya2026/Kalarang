...
export default function HeroSection({ banner, activeVideo, onWatchVideo }: HeroSectionProps) {
  ...
  return (
    <section id="hero-banner" className="relative lg:h-[75vh] min-h-[500px] bg-slate-900 overflow-hidden">
        ...
        {activeVideo ? (
          <div className="relative w-full h-full">
            ...
            <button
              ...
              className="absolute bottom-6 right-6 z-20 bg-espresso/70 hover:bg-maroon border border-gold/30 text-white rounded-full p-2.5 cursor-pointer backdrop-blur-sm transition-colors shadow-lg"
      ...
      <div className="relative max-w-7xl mx-auto px-4 h-full flex flex-col items-center justify-center sm:px-6 lg:px-8 z-10 py-12 lg:py-0">
        <motion.div
        ...
        >
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight leading-tight uppercase font-medium">
            {banner.headline}
          </h1>
          <p className="font-serif text-base sm:text-lg text-cream/90 leading-relaxed italic">
            {banner.subtext}
          </p>
          <div className="mt-4 flex flex-wrap gap-4 items-center justify-center">
            ...
            {activeVideo && (
              ...
              >
                <Play className="h-3.5 w-3.5 fill-white text-white" /> Watch Spotlight Video
              </button>
            )}
          </div>
        </motion.div>
